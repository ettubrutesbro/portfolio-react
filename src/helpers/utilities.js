...
export function makeEnclosure(volume, position, key){
  ...
  let bounds = [
    {name: key+'rightwall', x: (volume.x/2)+.25, y: 0, z:0, w: .5, h: volume.y, d: volume.z}, //r
    {name: key+'leftwall', x: -(volume.x/2)-.25, y: 0, z:0, w: .5, h: volume.y, d: volume.z}, //l
    {name: key+'backwall', x: 0, y: 0, z:-(volume.z/2)-.25, w: volume.x, h: volume.y, d: .5}, //b
    {name: key+'frontwall', x: 0, y: 0, z:(volume.z/2)+.25, w: volume.x, h: volume.y, d: .5}, //f
   ]
