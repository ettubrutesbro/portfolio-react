...
export default class Sidebar extends React.Component{
    ...
    reset(){
        ...
        sidebar.position.set(-.75,0,0.325)
    ...
    cycleIn(){
        ...
        this.sidebarTweens = [
            twn('scale', {x: 0.3}, {x: 1}, 250, sidebar.scale, {delay: 200, onStart: ()=>{sidebar.visible=true}}),
            twn('position', {x: -0.77} ,{x: -0.55}, 250, sidebar.position, {delay: 200}),
            twn('opacity', {opacity:0}, {opacity:1}, 250, sidebar, 
                {traverseOpacity: true, onComplete: ()=>{
                    store.bodies.sendbloom.allowSleep = true
                }, delay: 200}),
            twn('opacity', {opacity: 0}, {opacity: 1}, 200, this.refs.shadow.material, {delay: 200}),
            // twn('position', {x:-1})
        ]
