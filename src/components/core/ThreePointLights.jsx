...
export default class ThreePointLights extends React.Component{
    render(){
        ...
        return(
            <group>
                <pointLight
                    position={v3(light1.position.x, light1.position.y, light1.position.z)}
                    color={light1.color}
                    decay={3}
                    distance={36}
                    visible={light1.on}
                ...
                />
                <pointLight
                    position={v3(light2.position.x, light2.position.y, light2.position.z)}
                    color={light2.color}
                    decay={3}
                    distance={36}
                    visible={light2.on}
                ...
                />
                <pointLight
                    position={v3(light3.position.x, light3.position.y, light3.position.z)}
                    color={light3.color}
                    decay={3}
                    distance={36}
                    visible={light3.on}
